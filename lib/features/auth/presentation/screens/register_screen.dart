    ...
    return Form(
        child: Column(
          ...
          children: [
            ...
            CustomSeparator(height: 16),
            CustomTextFormField(controller: _passwordController, hintText: "Contraseña", obscureText: true),
            CustomSeparator(height: 16),
            CustomTextFormField(controller: _repeatPasswordController, hintText: "Repetir Contraseña", obscureText: true),
            CustomSeparator(height: 16),
